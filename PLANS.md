...
sin reintentos ni ajustes de goal, sin repair-center. El proyecto terminó
...
medición realizada, candidato no aprobado" arriba). No hay limitación de
MVP observada todavía que justifique promover nada de la lista de abajo --
primero cierran Gate-MVP.1 y Gate-MVP.2.
...
no volver a iterar de más") -- y el MVP todavía no pasó, así que esa
limitación tampoco está demostrada todavía.
